...
class BiographiesControllerTest < ActionController::TestCase
  ...
  test "should create biography" do
    assert_difference('Biography.count') do
      post :create, biography: { biografie: @biography.biografie, geburtsname: @biography.geburtsname, geburtsort: @biography.geburtsort, geburtstag: @biography.geburtstag, info: @biography.info, name: @biography.name, verlegedatum: @biography.verlegedatum }
    end
  ...
  test "should update biography" do
    patch :update, id: @biography, biography: { biografie: @biography.biografie, geburtsname: @biography.geburtsname, geburtsort: @biography.geburtsort, geburtstag: @biography.geburtstag, info: @biography.info, name: @biography.name, verlegedatum: @biography.verlegedatum }
    assert_redirected_to biography_path(assigns(:biography))
  end
